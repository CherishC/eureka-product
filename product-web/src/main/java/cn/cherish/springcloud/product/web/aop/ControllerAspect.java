package cn.cherish.springcloud.product.web.aop;

import cn.cherish.springcloud.product.service.common.enums.ErrorCode;
...
public class ControllerAspect {
	...
	@Around("execution(public me.cherish.web.MResponse" +
			" cn.cherish.springcloud.product.web.controller.*Controller.*(..))")
